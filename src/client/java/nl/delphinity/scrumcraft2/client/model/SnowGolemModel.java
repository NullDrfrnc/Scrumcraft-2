...
public class SnowGolemModel extends EntityModel<LivingEntityRenderState> {
    ...
    public void setupAnim(LivingEntityRenderState livingEntityRenderState) {
        ...
        this.upperBody.yRot = livingEntityRenderState.yRot * ((float)Math.PI / 180F) * 0.25F;
        float f = Mth.sin((double)this.upperBody.yRot);
        float g = Mth.cos((double)this.upperBody.yRot);
