...
public class ScrumMasterBallEntity extends ThrowableItemProjectile {


    public ScrumMasterBallEntity(EntityType<? extends UltimateScrumBallEntity> entityType, Level level) {
        super(entityType, level);
    }

    public ScrumMasterBallEntity(ServerLevel level, LivingEntity livingEntity, ItemStack stack) {
        super(ModEntityTypes.ULTIMATE_SCRUM_BALL_ENTITY, livingEntity, level, stack);
    }

    public ScrumMasterBallEntity(Level level, double d, double e, double f, ItemStack itemStack) {
    ...
    protected @NotNull Item getDefaultItem() {
        return ModItems.SCRUM_MASTER_BALL;
    }
