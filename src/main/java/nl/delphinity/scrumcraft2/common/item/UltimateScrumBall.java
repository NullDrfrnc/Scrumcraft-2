...
public class UltimateScrumBall extends Item implements ProjectileItem {
    public UltimateScrumBall(Properties properties) {
        super(properties);
    }
    ...
    public Projectile asProjectile(Level level, Position pos, ItemStack stack, Direction direction) {
        UltimateScrumBallEntity entity = new UltimateScrumBallEntity(level, pos.x(), pos.y(), pos.z(), stack);
